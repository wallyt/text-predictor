...
4. Construct predictive models that look at the last one, two and three words you typed (using Markov chains for one-, two- and three-gram models). To handle word combinations that weren't in the training corpus, the models will implement Kneser-Way smoothing, as well as backoff models.
...
6. Build a Shiny web app that uses the model to predict the next word you need as you type.
